<?php
/*session_start();
$connection = mysqli_connect("localhost", "root", "", "e_sms");

if (isset($_POST['update'])) {
    $name = mysqli_real_escape_string($connection,$_POST['st_name']);
    ...
    SET st_name='$name',dob='$dob',reg_no='$registration',fathers_name='$fa_name',email='$email',ph_no='$mob_no',branch='$branch',gender='$gender',adress='$adress',city='$city', semester='$semester',district='$dist',zip_cod='$zip' 
        ...
        <div class="table-responsive">
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="dataTable_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable" spellcheck="false" data-ms-editor="true"></label></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
