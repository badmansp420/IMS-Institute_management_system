        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php if (isset($_GET['reg_no'])) {
                    ...
                    $query = "select * from mark_sem_3 WHERE reg_no='$reg_no'";
                ...
                ?>
                        ...
                        <div class="container-fluid">
                            <h4 class="m-0 font-weight-bold text-danger text-center">Update Marks</h4>
                            <br>
                            <div class="card position-relative">
                                <div class="card-header py-2">
                                    <h4 class="m-0 font-weight-bold text-secondary text-center">(Semester - III)</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <select class="form-select" name="status" required>
                                                        ...
                                                        <option value="Pass" <?php if ($reg_no['st_status'] == "Pass") {
                                                                                    echo "selected";
                                                                                } ?>>Pass</option>
                                                        <option value="Back" <?php if ($reg_no['st_status'] == "Back") {
                                                                                    echo "selected";
                                                                                } ?>>Back</option>
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Parcentage" value="<?= $reg_no['parcentage'] ?>" pattern="[0-9]{2}[.][0-9]{2}" maxlength="5" name="parcentage" required>
                                                </div>
                                                <div class="col-3">
                                                    <label for="inputreg" class="form-label">GPA</label>
                                                    <input class="form-control" type="text" placeholder="GPA" value="<?= $reg_no['gpa'] ?>" pattern="[0-9]{1}[.][0-9]{1}" maxlength="5" name="gpa" required>
                                                </div>
                                                <div class="col-3">
                                                    <label for="inputreg" class="form-label">Grade</label>
                                                    <input class="form-control" type="text" placeholder="Grade" value="<?= $reg_no['grade'] ?>" pattern="[A-Z]{1}" maxlength="2" name="grade" required>
                                                </div>

                                                <div class="col text-center">
                                                    <br>
                                                    <br>
                                                    <a type="submit" href="st_search.php" name="back" id="back" class="btn btn-secondary">Back</a>
                                                </div>
                                                <div class="col text-center">
                                                    <br>
                                                    <br>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $gpa = $_POST['gpa'];
                    $grade = $_POST['grade'];
                    $query = "UPDATE mark_sem_3 SET reg_no='$registration', st_status= '$status', parcentage='$parcentage', gpa='$gpa', grade='$grade' WHERE reg_no='$registration'";
                    $query_run = mysqli_query($connection, $query);
                    if ($query_run) {
