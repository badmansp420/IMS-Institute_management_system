...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link active" href="table.php?page=<?= "1"; ?>">
            ...
            <div id="content">
                ...
                <div class="container-fluid align-center">
                    ...
                    <div class="card position-relative">
                        <div class="card-header py-2">
                            <h4 class="m-0 font-weight-bold text-primary">Add Marks For Student</h4>
                        </div>
                ...
                if (isset($_POST['show'])) {
                    ...
                    while ($row = mysqli_fetch_assoc($query_run)) {
                        ...
                        if ($row['ad_type'] == "Voclate") {
                            //header('location:marks_voclate.php');
                            echo "<script>window.top.location='marks_voclate.php'</script>";
                        } elseif ($row['ad_type'] == "Jexpo") {
                            //header('location:marks_jexpo.php');
                            echo "<script>window.top.location='marks_jexpo.php'</script>";
                        } else {
                            echo "<script>alert('Please Enter Correct Registration No')</script>";
                        }
                    }
                }
