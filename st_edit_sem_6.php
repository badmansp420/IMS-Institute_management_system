        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php if (isset($_GET['reg_no'])) {
                    ...
                    $query = "select * from mark_sem_6 WHERE reg_no='$reg_no'";
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-2">
                                    <h4 class="m-0 font-weight-bold text-secondary text-center">(Semester - VI)</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $gpa = $_POST['gpa'];
                    $grade = $_POST['grade'];
                    $query = "UPDATE mark_sem_6 SET reg_no='$registration', st_status= '$status', parcentage='$parcentage', gpa='$gpa', grade='$grade' WHERE reg_no='$registration'";
                    $query_run = mysqli_query($connection, $query);
                    if ($query_run) {
