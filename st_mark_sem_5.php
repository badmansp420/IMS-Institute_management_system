        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-2">
                                    <h4 class="m-0 font-weight-bold text-primary">Add (Semester - V) Student Marks</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-6 py-2">
                                                    ...
                                                    <input type="text" class="form-control" name="sem1" value="Semester - V" placeholder="Semester - II" disabled>
                                                </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $check = "select * from mark_sem_5 where reg_no = '$registration'";
                    $result = mysqli_query($connection, $check);
                    $count = mysqli_num_rows($result);
                    if ($count > 0) {
                        echo "<script>alert('Student Data is Already Stored In Our Database')</script>";
                    } else {
                        $query = "INSERT INTO mark_sem_5(reg_no, st_status, parcentage, gpa, grade) VALUES('$registration','$status','$parcentage','$gpa','$grade')";
                        $query_run = mysqli_query($connection, $query);
                        if ($query_run) {
